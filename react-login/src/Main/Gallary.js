...
export class Gallary extends Component {
  render() {
    return (
      ...
      <div className="col">
        <div className="card shadow-strong galleryImage h-100 rounded-5 ">
          <img src={ImageOne} className="card-img-bottom "
            alt="The first Image" />  
        </div>
      </div>
      <div className="col">
        <div className="card galleryImage h-100 rounded-5">
      ...
      <div className="col">
        <div className="card galleryImage rounded-5 h-100">
      ...
      <div className="col">
       ...
       <div className="col">
        <div className="card rounded-5 galleryImage h-100 ">
          <img src={ImageOne} className="card-img-bottom"
            alt="The first Image" />  
        </div>
      </div>
